...
void test1()
{
    ...
    rc = stl_ini_parse_string(NULL, cb, ini);
    assert(rc == 2);
}
...
void test2()
{
    ...
    rc = stl_ini_parse_string(&count, cb2, ini);
    assert(rc == 0);
}
...
void test3()
{
    ...
    rc = stl_ini_parse_string(&count, cb3, ini);
    assert(rc == 0);
    assert(count == 2);
}
...
void test4()
{
    ...
    rc = stl_ini_parse_string(&count, cb4, ini);
    assert(rc == 0);
    assert(count == 3);

    rc = stl_ini_parse_string(&count, cb4, NULL);
    assert(rc == 0);
}
...
void test5()
{
    ...
    static const char *ini2 = " ;Sample \n"
                              ...
                              " value1 \n"
                              "value2 ";
    rc = stl_ini_parse_string(&count, cb4, ini2);
    assert(rc == 5);
    assert(count == 2);
}
...
void test6()
{
    ...
    rc = stl_ini_parse_string(&count, cb6, ini);
    assert(rc == 3);
    assert(count == 0);
}
...
void test7()
{
    ...
    rc = stl_ini_parse_string(&count, cb7, ini);
    assert(rc == 4);
    assert(count == 1);
}
...
void test8()
{
    ...
    rc = stl_ini_parse_file(&count, cb8, "config.ini");
    assert(rc == 0);
    assert(count == 3);
    remove("config.ini");
...
void test9()
{
    ...
    rc = stl_ini_parse_string(&count, cb9, ini);
    assert(rc == 0);
}
...
void test11()
{
    ...
    rc = stl_ini_parse_string(&count, cb11, ini);
    assert(rc == 0);
}
...
void test12()
{
    ...
    rc = stl_ini_parse_string(&count, cb12, ini);
    assert(rc == 0);
}
...
void test13()
{
    ...
    rc = stl_ini_parse_string(&count, cb13, ini);
    assert(rc == 0);
    assert(count == 2);
}
...
void test14()
{
    ...
    rc = stl_ini_parse_string(&count, cb14, ini);
    assert(rc != 0);
}
...
void test15()
{
    ...
    rc = stl_ini_parse_file(&count, cb15, "config.ini");
    assert(rc != 0);
    remove("config.ini");
}
...
void test16()
{
    ...
    rc = stl_ini_parse_string(NULL, cb16, "key#  =  ;comment \n");
    assert(rc == 0);
    rc = stl_ini_parse_string(NULL, cb16, "key#  =  ;comment \n\n");
    assert(rc == 0);
    rc = stl_ini_parse_string(NULL, cb16, "key#  =  ;comment \nx=3\n");
    assert(rc == 0);
    rc = stl_ini_parse_string(NULL, cb16, "\n\0");
    assert(rc == 0);
}
...
void file_example(void)
{
    ...
    rc = stl_ini_parse_file(NULL, callback, "my_config.ini");
    assert(rc == 0);
}
...
void string_example(void)
{
    ...
    rc = stl_ini_parse_string(NULL, callback, example_ini);
    assert(rc == 0);
}
...
void test_fail()
{
    ...
    fail_ferror = true;
    rc = stl_ini_parse_file(NULL, cb_fail, "config.ini");
    assert(rc == -1);
    fail_ferror = false;
}
#else
